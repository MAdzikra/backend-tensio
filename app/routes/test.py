...
def register():
    ...
    if existing_user:
        ...
        # akun ada tapi belum verified => overwrite + resend verification
...
def verify_email(token):
    ...
    if user.verification_token != token:
        return jsonify({"message": "Verification link is no longer valid"}), 400
...
# =========================================================
# SET PASSWORD (GOOGLE ONLY / NO PASSWORD USER)
# =========================================================
...
def reset_password(token):
    ...
    if user.reset_password_token != token:
        return jsonify({"message": "Token already used or invalid"}), 400
